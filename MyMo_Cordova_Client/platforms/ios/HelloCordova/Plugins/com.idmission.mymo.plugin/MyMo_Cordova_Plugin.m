...
- (void)enableMyMoToAllowSendMoney:(CDVInvokedUrlCommand*)command
{
    ...
    NSString *bankUserName = [commandJsonString objectForKey:@"bankUserName"];
    ...
    NSString *IdNumber = [commandJsonString objectForKey:@"idNumber"];
    ...
    [userDefaults setObject:@"Y" forKey:@"isEnable_MyMO"];
    [userDefaults setObject:@"Y" forKey:@"isShowSendMoney"];
    [userDefaults setObject:@"Y" forKey:@"isShowSendToATM"];
    [userDefaults setObject:@"Y" forKey:@"isShowHistory"];
    ...
    [userDefaults setObject:IdNumber forKey:@"ID_Number"];
    ...
    [userDefaults setObject:bankUserName forKey:@"Bank_User_Name"];
...
- (void)disableMyMoToRestrictSendMoney:(CDVInvokedUrlCommand*)command
{
    ...
    NSUserDefaults *userDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.bancatlan.sp05"];
    [userDefaults setObject:@"N" forKey:@"isEnable_MyMO"];
}
